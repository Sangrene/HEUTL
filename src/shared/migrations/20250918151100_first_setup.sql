...
CREATE TABLE IF NOT EXISTS entity_subscriptions (id TEXT PRIMARY KEY, entity_sharing_id TEXT, created_at INTEGER, updated_at INTEGER, connected_app_id TEXT,
 jdm_transform TEXT, python_script TEXT);
CREATE TABLE IF NOT EXISTS entity_sharings (id TEXT PRIMARY KEY, name TEXT, created_at INTEGER, updated_at INTEGER, polling_infos TEXT, json_schema TEXT,
 connected_app_id TEXT, data_path TEXT, is_array BOOLEAN, python_script TEXT);
